/*
 * ctypepromise.test.js - test the character type information functions
 *
...
describe("testctypepromise", () => {
    ...
    test("IsLowerTrue", () => {
        ...
        return isLower._init(false).then(() => {
    ...
    test("IsUpperTrue", () => {
        expect.assertions(11);
        return isUpper._init(false).then(() => {
    ...
    test("IsPrintTrue", () => {
        expect.assertions(7);
        return isPrint._init(false).then(() => {
    ...
    test("IsAsciiTrue", () => {
        ...
        return isAscii._init(false).then(() => {
    ...
    test("IsBlankTrue", () => {
        expect.assertions(13);
        return isBlank._init(false).then(() => {
    ...
    test("IsSpaceTrue", () => {
        expect.assertions(11);
        return isSpace._init(false).then(() => {
    ...
    test("IsPunctTrue", () => {
        ...
        return isPunct._init(false).then(() => {
    ...
    test("IsIdeoTrue", () => {
        ...
        return isIdeo._init(false).then(() => {
    ...
    test("IsCntrlTrue", () => {
        expect.assertions(10);
        return isCntrl._init(false).then(() => {
    ...
    test("IsDigitTrue", () => {
        ...
        return isDigit._init(false).then(() => {
    ...
    test("IsXdigitTrue", () => {
        ...
        return isXdigit._init(false).then(() => {
    ...
    test("IsScriptTrue", () => {
        ...
        return isScript._init(false).then(() => {
    ...
    test("IsAlnum", () => {
        expect.assertions(11);
        return isAlnum._init(false).then(() => {
    ...
    test("IsGraphTrue", () => {
        expect.assertions(5);
        return isGraph._init(false).then(() => {
