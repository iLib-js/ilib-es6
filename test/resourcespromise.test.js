...
describe("testresourcespromise", () => {
    ...
    test("ResBundleAsyncGetStringOtherBundleesMX", () => {
        ...
        return ResBundle.create({
            ...
            expect(rb.getStringJS("Hello from {country}")).toBe("Que tal de {country}");
            expect(rb.getStringJS("Hello from {city}")).toBe("Que tal de {city}");
            expect(rb.getStringJS("Greetings from {city} in {country}")).toBe("Hola de {city} en {country}");
        });
